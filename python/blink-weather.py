...
wunderground_api_key = 'f4198890da4a270e' # wunderground api key: get it free here http://www.wunderground.com/weather/api/
weather_zip = '44017'
...
def check_weather():
  ...
  while True:
    ...
    # extract the temp
    temp = float(api['current_observation']['feelslike_f'])
